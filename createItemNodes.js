...
var pascalize = _require.pascalize;
...
var Item = require('datocms-client/lib/local/Item');
var ItemsRepo = require('datocms-client/lib/local/ItemsRepo');
...
module.exports = function createItemNodes(repo, createNode) {
  ...
  var itemsRepo = new ItemsRepo(repo);
    ...
    items.forEach(function (item) {
      ...
      item.itemType.fields.forEach(function (field) {
        ...
        switch (fieldType) {
          ...
          default:
            {
              var fieldValue = build(field.fieldType, value, itemsRepo);
  ...
  Object.entries(itemNodes).forEach(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 2);

    var key = _ref2[0];
    var itemNode = _ref2[1];
